...
test_button0 = Button(blue_theme, (115, 10, 200, 100), button_font, parent= buttons, text= "hello")
test_button1 = Button(red_theme, (115, 120, 200, 100), button_font, parent= buttons, text = "hello again")
test_button2 = Button_Toggle(red_theme, (320, 10, 200, 100), button_font, 100, parent= buttons, text = "progress")
event0 = Event(lambda : test_button1.activate())
event1 = Event(lambda : res_gold + 1, cost= [(res_potatoes, 1)])
event2null = Event(lambda : True)
event2p = Event(lambda : test_button2.prog(1), cost= [(res_gold, 0.1)])
